...
/---------------------------------------------------------------//
//DEVELOPER MODE
require('../module/live-reload.js')(__dirname+'/public', io, 'reisconobras.com.br');
...
server.listen(app.get('port'), function() {
    var msg = 'Projeto reisconobras.com.br esta executando na porta ' + app.get('port') + ' e IP '+process.env.IP +' em '+moment().format('MMMM Do YYYY, h:mm:ss a'); + '\n'
        + JSON.stringify(config);
        console.log(msg);
        redisClient.rpush('reisconobras.com.br::::system::mail::administrator', JSON.stringify({text : msg, html : '<b>'+msg+'</b>'}));
});
