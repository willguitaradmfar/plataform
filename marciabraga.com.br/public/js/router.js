...
angular.module('app', ['app.controllers', 'app.resource', 'app.directive']).
    ...
    $routeProvider.when('/15anos', {templateUrl: 'partials/_15anos.tpl', controller: '15anosController'});
    $routeProvider.when('/15anos/:id', {templateUrl: 'partials/_15anos.tpl', controller: '15anosController'});
