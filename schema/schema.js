...
var disponibilidadeObjSchema = {};
disponibilidadeObjSchema.nome = "String";
disponibilidadeObjSchema.valores = [String];
...
produtoObjSchema.disponibilidades = [disponibilidadeObjSchema];
